...
class LoadBalancer implements Runner {
  ...
  /// as normal.
  Future<R> run<R, P>(R function(P argument), argument, {Duration timeout,
                                            onTimeout(),
                                            int load: 100}) {
...
class _LoadBalancerEntry implements Comparable<_LoadBalancerEntry> {
  ...
  Future<R> run<R, P>(LoadBalancer balancer, int load, R function(P argument), argument,
             Duration timeout, onTimeout()) {
    return runner.run<R, P>(function, argument,
